        ...
        <div className="flex flex-col-reverse md:flex-row items-center gap-12">
          ...
          <div className="w-full md:w-1/2 space-y-6 text-center md:text-left">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 justify-center md:justify-start pt-4">
              ...
              <a
                href="#"
                className="w-full sm:w-auto px-8 py-3 bg-white text-navy-900 border border-slate-200 rounded-lg font-semibold hover:bg-slate-50 hover:border-slate-300 hover:shadow-md transition-all duration-300 flex items-center justify-center gap-2"
              >
               ...
               <a
                ...
                className="w-full sm:w-auto px-8 py-3 text-slate-600 font-medium hover:text-navy-900 transition-colors flex items-center justify-center gap-2"
              >
